app.controller('desuscritos', verDesuscritos);

function verDesuscritos($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTDefaultOptions, $http, $q, $resource) {
	var vm = this;
	...
	vm.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
		var defer = $q.defer();
		$http.get( 'v1/list/desuscrito' ).then(function(result) {
			defer.resolve(result.data.data);
			vm.numDesuscrito = "Número de contactos desuscritos : " + result.data.data.length;
		});
